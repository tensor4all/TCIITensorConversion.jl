...
"""
    function TCI.TensorTrain{V}(mps::ITensorMPS.MPS)
...
"""
function TCI.TensorTrain{V}(mps::ITensorMPS.MPS) where {V}
...
TCI.TensorTrain(mps::ITensorMPS.MPS) = TCI.TensorTrain{ComplexF64}(mps)
